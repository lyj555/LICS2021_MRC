...
def compute_prediction_span(examples,
                            features,
                            predictions,
    ...
    for example_index, example in enumerate(examples):
            ...
            for start_index in start_indexes:
                for end_index in end_indexes:
                    ...
                    if (start_index >= len(offset_mapping) or end_index >= len(offset_mapping) or
                            ...
                            offset_mapping[start_index] == (0, 0) or offset_mapping[end_index] == (0, 0)):
                        continue
        ...
        if not version_2_with_negative:
            ...
            i = 0
            while i < len(predictions) and predictions[i]["text"] == "no answer":
                i += 1
            if i == len(predictions):
                best_non_null_pred = {"text": "no answer"}
            else:
